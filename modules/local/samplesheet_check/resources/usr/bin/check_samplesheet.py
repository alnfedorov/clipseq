...
class RowChecker:
        ...
        **kwargs,
        ...
        Args:
            sample_col (str): The name of the column that contains the sample name
                (default "sample").
            fastq_col (str): The name of the column that contains the first (and only)
    ...
    def validate_unique_samples(self):
        ...
        cnts = Counter([row[self._sample_col] for row in self.modified])
        for row in self.modified:
            sample = row[self._sample_col]
            seen = cnts[sample]
            if seen > 1:
                row[self._sample_col] = f"{sample}_T{seen}"
...
def check_samplesheet(file_in, file_out):
    ...
    Example:
        This function checks that the samplesheet follows the following structure:
            ...
            sample,fastq
            sample1,sample1_run1.fastq.gz,
            sample1,sample1_run2.fastq.gz,
